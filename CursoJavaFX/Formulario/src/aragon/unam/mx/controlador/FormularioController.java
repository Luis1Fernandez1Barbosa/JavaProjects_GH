...
public class FormularioController extends BaseController implements Initializable {
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		...
		this.cbbEstado.getItems().addAll("Aguascalientes", "Baja California", "Baja California Sur", "Campeche","Ciudad de México","Coahuila","Colima", "Chiapas", 
				"Chihuahua", "Durango", "Guanajuato", "Guerrero", "Hidalgo", "Jalisco", "Estado de México", "Michoacán", "Morelos", "Nayarit", "Nuevo León", "Oaxaca", 
	...
	private boolean verificar() {
		...
		if (this.rdbHonorarios==null && !this.rdbHonorarios.isSelected()) {
			valido = false;
			this.mensajes += "Seleccione un régimen\n";
		}
		return valido;
	}
}
